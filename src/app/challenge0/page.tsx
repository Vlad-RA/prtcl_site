...
export default function Challenge0Page() {
  ...
  useEffect(() => {
    if (isLoaded) {
      ...
      // If currentChallengeIndex is 0, stay on this page (Challenge0Page).
    }
  ...
  const handleLoginSubmit = (e: React.FormEvent) => {
    ...
    const currentChallengeConfig = challenges[0]; // Login challenge is always the first (index 0)
